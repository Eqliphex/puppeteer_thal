...
const BUTTON_LOGIN_SELECTOR = '#login > form > div.auth-form-body.mt-3 > input.btn.btn-primary.btn-block';
...
const LENGTH_SELECTOR_CLASS = 'user-list-class';
